...
from pages.inventroy_page import InventoryPage
...
class DashBoardPage:
    def __init__(self, root, username):
        ...
        self.sales_ui = SalesPage(self.root, self.back_dashboard, username=self.username)
        self.sales_ui.place_frame(1, 1)

        self.inventrory_page = InventoryPage(self.root, self.back_dashboard, username=self.username)
        self.inventrory_page.place_frame(1, 1)



        self.reminger_page = ReminderPage(self.root, self.back_dashboard)
        self.reminger_page.place_frame(1,1)
    ...
    def create_widgets(self):
        ...
        self.welcome = ttk.Label(self.frame, text="", font="calibri 24 bold", style="danger")
    ...
    def open_inventory(self):
        ...
        self.inventrory_page.inventroy_lgoic.inv_db.load_data()

    def open_reminder(self):
        self.reminger_page.frame.tkraise()
        self.reminger_page.reminder_db.load_reminder_data()


    def logout(self):
        import logic.app
        logic.app.App(self.root).show_login()
